...
def make_security_system_net():
    ...
    # TODO: finish this function͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐    
...
def set_probability(bayes_net):
    """
        ...
        "D"'. (for the tests to work.)
    """
    # TODO: set the probability distribution for each node͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
    raise NotImplementedError    
    return bayes_net
...
def get_game_network():
    ...
    """
    BayesNet = BayesianNetwork()
    # TODO: fill this out͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
    raise NotImplementedError    
    return BayesNet
...
def Gibbs_sampler(bayes_net, initial_state):
    ...
    if variable_index == 0:
        # Sample A͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
        raise NotImplementedError
    elif variable_index == 1:
        # Sample B͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
        raise NotImplementedError
    elif variable_index == 2:
        # Sample C͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
        raise NotImplementedError

    elif variable_index == 4:
        # Sample BvC͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
        raise NotImplementedError
...
def sampling_question():
    ...
    """
    # TODO: assign value to choice and factor͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏︇͏󠄋͏󠄐
    raise NotImplementedError
    choice = 2
